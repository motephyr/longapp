...
|
*/
Encore.addEntry('app', './resources/src/js/app.js')
...
Encore.configureDevServerOptions((options) => {
    ...
    options.static.push({
        directory: path.join(__dirname, './resources/src'),
        watch: true,
    })
...
config.resolve.alias['@'] = path.resolve(__dirname, 'resources/src');
